...
export const Footer = () => (
    <div className="blue-background text-white p-3">
        ...
        {/* <div className="row">
            ...
            <a href="https://github.com/selenajosephine" className="text-white col-sm text-center">GitHub</a>
            <a href="https://novelcodes.com/" className="text-white col-sm text-center">NovelCodes</a>
        </div>
        <div className="row text-center justify-content-center">
